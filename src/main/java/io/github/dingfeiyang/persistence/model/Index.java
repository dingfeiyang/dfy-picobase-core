package io.github.dingfeiyang.persistence.model;
...
public class Index {
    ...
    public String build() {
        ...
        if (StrUtil.isNotBlank(this.getSchemaName())) {
            // str.append("`");
            str.append(DbxUtil.quoteSimpleColumnName(this.getSchemaName()));
            // str.append("`.");
        }

        // str.append("`");
        str.append(DbxUtil.quoteSimpleColumnName(this.getIndexName()));
        // str.append("` ");

        str.append(" ON ");
        str.append(DbxUtil.quoteSimpleTableName(this.getTableName()));
        str.append(" (");
        ...
        for (IndexColumn col : this.getColumns()) {
            ...
            if (StrUtil.contains(col.getName(), "(") || StrUtil.contains(col.getName(), " ")) {
                ...
                // regular identifier
                // str.append("`");
                str.append(DbxUtil.quoteSimpleColumnName(trimmedColName));
                // str.append("`");
            }
