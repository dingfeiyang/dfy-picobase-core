...
public class AbsentRule implements Rule {
     ...
     */
    private static final Err ErrNil = Err.newError("validation_nil", "must be blank");

    /**
     * ErrEmpty is the error that returns when a not nil value is not empty.
     */
    private static final Err ErrEmpty = Err.newError("validation_empty", "must be blank");
