package io.github.dingfeiyang.logic;
...
import io.github.dingfeiyang.annotation.PbCollection;
import io.github.dingfeiyang.context.PbHolder;
import io.github.dingfeiyang.exception.BadRequestException;
import io.github.dingfeiyang.exception.ForbiddenException;
import io.github.dingfeiyang.exception.NotFoundException;
...
import io.github.dingfeiyang.model.QueryParam;
import io.github.dingfeiyang.model.RecordModel;
import io.github.dingfeiyang.model.RequestInfo;
import io.github.dingfeiyang.model.event.RecordViewEvent;
import io.github.dingfeiyang.model.event.RecordsListEvent;
...
import io.github.dingfeiyang.persistence.mapper.Editor;
...
import io.github.dingfeiyang.search.PbProvider;
...
import static io.github.dingfeiyang.logic.RecordHelper.*;
    ...
    public void download(String collectionNameOrId, String recordId, String filename) {
        ...
        if (StrUtil.isNotEmpty(thumb) && (ListUtil.existInArray(thumb, DEFAULT_THUMB_SIZES) || ListUtil.existInArray(thumb, options.getThumbs().toArray(new String[0])))) {
            ...
            if (ListUtil.existInArray(file.getContentType(), IMAGE_CONTENT_TYPES)) {
                ...
                servedPath = Paths.get(baseFilesPath, PbFileSystem.THUMB_PREFIX + filename, servedName);
