package io.github.dingfeiyang.log;
 ...
 * Pb 日志实现类 [ 控制台打印 ]
 */
public class PbLogForConsole implements PbLog {
     ...
     * 日志输出的前缀
     */
    public static String LOG_PREFIX = "PbLog -->: ";
    public static String TRACE_PREFIX = "PB [TRACE]-->: ";
    public static String DEBUG_PREFIX = "PB [DEBUG]-->: ";
    public static String INFO_PREFIX = "PB [INFO] -->: ";
    public static String WARN_PREFIX = "PB [WARN] -->: ";
    public static String ERROR_PREFIX = "PB [ERROR]-->: ";
    public static String FATAL_PREFIX = "PB [FATAL]-->: ";
    ...
    public void println(int level, String color, String prefix, String str, Object... args) {
        prefix = StrFormatter.format(prefix + "[thread-{}] ", Thread.currentThread().getId());
        PbConfig config = PbManager.getConfig();
