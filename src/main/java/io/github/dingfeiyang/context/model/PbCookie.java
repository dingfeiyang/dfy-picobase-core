package io.github.dingfeiyang.context.model;
...
public class PbCookie {
     ...
     * @param value 值
     */
    public PbCookie(String name, String value) {
        this.name = name;
        this.value = value;
    }
     ...
     * @return 对象自身
     */
    public PbCookie setName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return 对象自身
     */
    public PbCookie setValue(String value) {
        this.value = value;
        return this;
    }
     ...
     * @return 对象自身
     */
    public PbCookie setMaxAge(int maxAge) {
        this.maxAge = maxAge;
        return this;
    }
     ...
     * @return 对象自身
     */
    public PbCookie setDomain(String domain) {
        this.domain = domain;
        return this;
    }
     ...
     * @return 对象自身
     */
    public PbCookie setPath(String path) {
        this.path = path;
        return this;
    }
     ...
     * @return 对象自身
     */
    public PbCookie setSecure(Boolean secure) {
        this.secure = secure;
        return this;
    }
     ...
     * @return 对象自身
     */
    public PbCookie setHttpOnly(Boolean httpOnly) {
     ...
     * @return 对象自身
     */
    public PbCookie setSameSite(String sameSite) {
    ...
    public String toHeaderValue() {
        ...
        if (value != null && value.contains(";")) {
            throw new PbException("无效Value：" + value).setCode(PbErrorCode.CODE_12003);
        }
