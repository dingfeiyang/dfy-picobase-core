package io.github.dingfeiyang.listener;
...
import static io.github.dingfeiyang.PbManager.log;


/**
 * Pb 侦听器的一个实现：Log 打印
 */
public class PbListenerForLog implements PbListener {

    /**
     * 每次登录时触发
     */
    @Override
    public void doLogin(String loginType, Object loginId, String tokenValue, PbLoginModel loginModel) {
     ...
     */
    @Override
    public void doSetConfig(PbConfig config) {
        if (config != null) {
