...
import io.github.dingfeiyang.interceptor.InterceptorNextFunc;
...
import io.github.dingfeiyang.model.schema.fieldoptions.CollectionAuthOptions;
import io.github.dingfeiyang.model.schema.fieldoptions.CollectionViewOptions;
...
import io.github.dingfeiyang.persistence.resolver.RecordFieldResolver;
import io.github.dingfeiyang.search.SearchFilter;
import io.github.dingfeiyang.validator.Err;
import io.github.dingfeiyang.validator.Errors;
import io.github.dingfeiyang.validator.RequiredRule;
import io.github.dingfeiyang.validator.RuleFunc;
import io.github.dingfeiyang.model.validators.Validators;

import java.util.*;

import static io.github.dingfeiyang.util.PbConstants.*;
import static io.github.dingfeiyang.util.PbConstants.CollectionType.*;
import static io.github.dingfeiyang.util.PbConstants.FieldType.Relation;
import static io.github.dingfeiyang.validator.Err.newError;
import static io.github.dingfeiyang.validator.Err.newErrors;
...
public class CollectionUpsert {
    ...
    public Errors validate(boolean isCreat) {
        ...
        return PbUtil.validate(this,
                field(CollectionUpsert::getId, when(isNew, length(DEFAULT_ID_LENGTH, DEFAULT_ID_LENGTH), match(ID_REGEX_P), by(Validators.uniqueId(this.collection.tableName())))
