...
public class CommonHelper {
     ...
     * 打印 Banner
     * <p>
     * From: https://patorjk.com/software/taag/#p=display&f=Calvin%20S&t=picobase
     */
    ...
    public static String encodeUrl(String url) {
        try {
            ...
            throw new PbException(e).setCode(PbErrorCode.CODE_12103);
        }
    }
    ...
    public static String decoderUrl(String url) {
        try {
            ...
            throw new PbException(e).setCode(PbErrorCode.CODE_12104);
        }
    }
