 ...
 */
package io.github.dingfeiyang.secure;
...
public class PbSecureUtil {
    ...
    public static String md5(String str) {
        ...
        try {
            ...
            throw new PbException(e).setCode(PbErrorCode.CODE_12111);
        }
    }
    ...
    public static String sha1(String str) {
        try {
            ...
            throw new PbException(e).setCode(PbErrorCode.CODE_12112);
        }
    }
    ...
    public static String sha256(String str) {
        try {
            ...
            throw new PbException(e).setCode(PbErrorCode.CODE_12113);
        }
    }
    ...
    public static String sha384(String str) {
        try {
            ...
            throw new PbException(e).setCode(PbErrorCode.CODE_121131);
        }
    }
    ...
    public static String sha512(String str) {
        try {
            ...
            throw new PbException(e).setCode(PbErrorCode.CODE_121132);
        }
    }
    ...
    public static String aesEncrypt(String key, String text) {
        try {
            ...
            throw new PbException(e).setCode(PbErrorCode.CODE_12114);
        }
    }
    ...
    public static String aesDecrypt(String key, String text) {
        try {
            ...
            throw new PbException(e).setCode(PbErrorCode.CODE_12115);
        }
    }
    ...
    public static String rsaEncryptByPublic(String publicKeyString, String content) {
        try {
            ...
            throw new PbException(e).setCode(PbErrorCode.CODE_12116);
        }
    }
    ...
    public static String rsaEncryptByPrivate(String privateKeyString, String content) {
        try {
            ...
            throw new PbException(e).setCode(PbErrorCode.CODE_12117);
        }
    }
    ...
    public static String rsaDecryptByPublic(String publicKeyString, String content) {
        ...
        try {
            ...
            throw new PbException(e).setCode(PbErrorCode.CODE_12118);
        }
    }
    ...
    public static String rsaDecryptByPrivate(String privateKeyString, String content) {
        try {
            ...
            throw new PbException(e).setCode(PbErrorCode.CODE_12119);
        }
    }
